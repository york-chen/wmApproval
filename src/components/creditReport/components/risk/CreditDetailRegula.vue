    ...
    <div class="credit-detail">
      ...
      >
        ...
        <el-table-column
          ...
          min-width="120"
        ></el-table-column>
        <el-table-column prop="case_no" label="文书编号" header-align="center" width="200"></el-table-column>
        <el-table-column
          prop="org_level"
          label="机构等级"
          header-align="center"
        ...
        ></el-table-column>
        <el-table-column prop="pub_date" label="处罚生效日期" align="center" width="130"></el-table-column>
      </el-table>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    data() {
      return (this.detail.entUntrusted && this.detail.entUntrusted.ci) || []
    }
  }
}
</script>
