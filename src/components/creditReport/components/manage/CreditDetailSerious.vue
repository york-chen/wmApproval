  ...
  <div>
    ...
    <div class="credit-detail">
      ...
      >
        ...
        <el-table-column prop="type" label="类别" width="140" align="center"></el-table-column>
        <el-table-column prop="fact" label="违法事实" header-align="center" min-width="220"></el-table-column>
        <el-table-column prop="put_date" label="列入日期" align="center" min-width="140">
          <template slot-scope="scope">
            {{ scope.row.put_date | formatDate('YMD') }}
          </template>
        </el-table-column>
        <el-table-column
          prop="put_department"
