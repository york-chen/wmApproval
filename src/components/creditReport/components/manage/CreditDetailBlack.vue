  ...
  <div>
    ...
    <div class="credit-detail">
      ...
      >
        ...
        <el-table-column prop="time" label="发布日期" align="center" width="160"></el-table-column>
        <el-table-column prop="status" label="是否有记录" align="center" min-width="300">
...
export default {
  ...
  computed: {
    ...
    data() {
      return (this.detail.entUntrusted && this.detail.entUntrusted.qb) || []
    }
  }
}
</script>
